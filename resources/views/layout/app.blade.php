    ...
    <header class="header-area">
        ...
        <div class="logo-area text-center">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <a href="index.html" class="original-logo"><img src="{{ asset('img/core-img/logo.png') }}"
                                alt=""></a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.6s"
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="single-blog-thumbnail">
                                    <img src="{{ asset('img/blog-img/6.jpg') }}" alt="">
                                    <div class="post-date">
                                        <a href="#">12 <span>march</span></a>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <a href="#"><img src="{{ asset('img/bg-img/add.gif') }}" alt=""></a>
                        </div>
    ...
    <div class="instagram-feed-area">
        ...
        <div class="instagram-slides owl-carousel">
            ...
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/1.png') }}" alt="">
                <!-- Hover Effects -->
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/2.png') }}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i
                            class="fa fa-instagram"></i></a>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/3.png') }}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i
                            class="fa fa-instagram"></i></a>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/4.png') }}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i
                            class="fa fa-instagram"></i></a>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/5.png') }}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i
                            class="fa fa-instagram"></i></a>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/6.png') }}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i
                            class="fa fa-instagram"></i></a>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset('img/instagram-img/7.png') }}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i
                            class="fa fa-instagram"></i></a>
